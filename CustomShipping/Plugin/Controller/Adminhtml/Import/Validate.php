...
namespace Ecommage\CustomShipping\Plugin\Controller\Adminhtml\Import;
...
class Validate
{
     ...
     * @param \PhpOffice\PhpSpreadsheet\Reader\Xlsx $xlsxReader
     *
    ...
    public function aroundExecute(
        ...
        if ($data) {
            ...
            try {
                ...
                if (stripos($sourcePath, '.xlsx')) {
                    $spreadsheet = $this->_xlsxReader->load($sourcePath);
                    $source = new \Ecommage\CustomShipping\Model\Import\Source\Xlsx(
                        $sourcePath,
                        $spreadsheet,
                        $data[$import::FIELD_FIELD_SEPARATOR]
                    );
                } elseif (stripos($sourcePath, '.txt')) {
                    $source = new \Ecommage\CustomShipping\Model\Import\Source\Txt(
                        $sourcePath,
                        $directory,
                        $data[$import::FIELD_FIELD_SEPARATOR]
                    );
